...
anova_priority_AM1 <- anova(varpart_priority_AM1$models$`Block-Env`, varpart_priority_AM1$models$`Block-Env-Prior`, show.time = "all", resamp = "pit.trap")
...
```{r, fig.width = 3, fig.height = 2.5, dpi = 600, dev.args= list(pointsize=8)}
cols <- c("#98DF8A", "#9EDAE5", "#F7B6D2")
names(cols) <- c("Block", "Env", "Priority")
