Supporting Information 3 – Between and within treatment variability
================
Rodolfo Pelinson
2026-04-21
...
```
    ...
    ## Warning in betadisper(distance, group = Exp_design_all_2$treatments_AM): some
...
![](SI_3_between_within_variability_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](SI_3_between_within_variability_files/figure-gfm/unnamed-chunk-8-2.png)<!-- -->
...
```
    ...
    ## Data: data_between
    ## Models:
    ## mod_beta_between0: between_dist ~ 1 + (1 | treatments), zi=~0, disp=~1
    ## mod_beta_between1: between_dist ~ AM_days + (1 | treatments), zi=~0, disp=~1
    ## mod_beta_between2: between_dist ~ AM_days + I(AM_days^2) + (1 | treatments), zi=~0, disp=~1
    ##                   Df     AIC     BIC logLik deviance  Chisq Chi Df Pr(>Chisq)
    ## mod_beta_between0  3 -33.732 -31.414 19.866  -39.732                         
    ## mod_beta_between1  4 -31.838 -28.748 19.919  -39.838 0.1064      1     0.7443
    ## mod_beta_between2  5 -29.975 -26.112 19.988  -39.975 0.1371      1     0.7112
...
plot(data_within$within_dist ~ jitter(AM_days, 1),
     data = data_within, xaxt = "n", ylab = "", xlab = "", type = "n", ylim = c(0.1,0.6), xlim = c(min(unique_AM_days_within)*1.25,max(unique_AM_days_within)*1.25),  xaxs = "i")
...
plot(data_between$between_dist ~ jitter(AM_days, 1),
     data = data_between, xaxt = "n", ylab = "", xlab = "", type = "n", ylim = c(0.1,0.6), xlim = c(min(unique_AM_days_between)*1.25,max(unique_AM_days_between)*1.25),  xaxs = "i")
...
![](SI_3_between_within_variability_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
