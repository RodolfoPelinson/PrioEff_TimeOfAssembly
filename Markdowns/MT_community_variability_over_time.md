How does community variability change over time?
================
Rodolfo Pelinson
2026-03-31
...
Excluding the late treatment from this analysis and preparing data
...
#This is a function to unscale the predictor for plotting
...
average number of species in each survey fixed. This is done through the
custom function beta_deviation() that can be find in the functions
folder. It heavily rely on the betadisper and null models of the vegan
package.
...
beta_dev <-  beta_deviation(comm_all_2, keep_fill = TRUE, method = "quasiswap", dist = "bray", fixedmar="both", shuffle = "both", group = AM_by_block,
                                  strata = Exp_design_all_2$AM,  mtype = "count", times = 1000, burnin = 0, thin = 0, transform = NULL, seed = 1, type = "centroid", bias.adjust = FALSE)
```
...
```
    ...
    ## [[1]]
    ##  [1] 6 6 3 6 6 4 5 3 5 2 5 6 5 5 3 3 7 5 6 3 3 4 3 6
    ## 
    ## [[2]]
    ##  [1] 3 8 4 5 6 4 6 5 7 2 4 4 6 5 4 6 5 3 3 4 2 5 4 5
    ## 
    ## [[3]]
    ##  [1] 5 5 5 6 4 2 4 5 3 3 5 7 3 5 5 6 4 5 7 5 3 5 4 4
    ## 
    ## [[4]]
    ##  [1] 6 7 5 4 6 3 4 5 3 2 4 4 6 4 5 3 5 3 8 4 3 5 6 5
    ## 
    ## [[5]]
    ##  [1] 7 4 2 4 5 3 3 4 5 8 5 7 4 6 5 3 6 5 5 5 3 4 3 4
    ## 
    ## [[6]]
    ##  [1] 5 3 3 7 6 2 5 5 5 4 6 5 2 7 5 6 3 4 3 8 4 4 5 3
...
```
    ...
    ## [[1]]
    ##  [1] 5 5 2 3 5 2 4 8 5 3 6 4 7 4 5 6 5 3 7 6 3 2 3 7
    ## 
    ## [[2]]
    ##  [1] 6 4 6 3 5 5 4 6 5 3 5 7 3 6 4 6 3 5 5 4 2 5 4 4
    ## 
    ## [[3]]
    ##  [1] 4 8 3 4 6 3 4 6 7 4 5 4 5 6 4 4 6 2 4 4 5 3 5 4
    ## 
    ## [[4]]
    ##  [1] 4 6 4 4 4 3 7 6 5 3 4 4 5 6 4 5 6 3 6 4 4 4 5 4
    ## 
    ## [[5]]
    ##  [1] 7 4 4 6 4 3 2 4 4 6 3 8 6 3 5 6 5 5 4 5 5 6 4 1
    ## 
    ## [[6]]
    ##  [1] 5 4 6 5 3 3 6 5 6 2 4 5 6 3 4 4 4 4 6 5 3 5 7 5
...
Ok. The local diversities vary, but the averages are always the same.
Always fixed.
...
```
    ...
    ##                     Df     AIC     BIC logLik deviance  Chisq Chi Df Pr(>Chisq)
    ## mod_exp_null         4 -217.93 -207.67 112.97  -225.93                         
    ## mod_exp_am_num       5 -216.78 -203.96 113.39  -226.78 0.8497      1   0.356640
    ## mod_exp_am_num_quad  6 -222.44 -207.05 117.22  -234.44 7.6535      1   0.005666
    ##                       
    ## mod_exp_null          
    ## mod_exp_am_num        
    ## mod_exp_am_num_quad **
...
```
    ...
    ##                     Df    AIC    BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)
    ## mod_dev_null         4 362.23 372.48 -177.11   354.23                         
    ## mod_dev_am_num       5 352.67 365.50 -171.34   342.67 11.551      1   0.000677
    ## mod_dev_am_num_quad  6                                            1           
    ##                        
    ## mod_dev_null           
    ## mod_dev_am_num      ***
    ## mod_dev_am_num_quad    
...
![](MT_community_variability_over_time_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->

``` r
plot(simulateResiduals(mod_exp_am_num_quad))
```

![](MT_community_variability_over_time_files/figure-gfm/unnamed-chunk-14-2.png)<!-- -->

``` r
plot(simulateResiduals(mod_dev_am_num_quad))
```

![](MT_community_variability_over_time_files/figure-gfm/unnamed-chunk-14-3.png)<!-- -->
...
![](MT_community_variability_over_time_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
