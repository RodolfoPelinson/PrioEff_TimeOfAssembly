...
Prior community structure: 2 Time: 2 Environment: 2 Block: 1 factor with
...
screen(4)
par(mar = c(2,1,1,1))
barplot(full_model_sp, ylim = c(0,0.7), las = 2, border = "white", col = "#C7C7C7", xaxt = "n", xaxs = "i", width = 1, space = 0.5, xlim = c(0,20), yaxt = "n")
par(new = TRUE)
...
screen(3)
par(mar = c(2,4,1,1))
barplot(total_r2, ylim = c(0,0.7), las = 2, border = "white", col = "#C7C7C7", xaxt = "n", xaxs = "i", width = 1, space = 0.5, xlim = c(0,2), yaxt = "n")
par(new = TRUE)
...
barplot(pure_scaleds, ylim = c(0,0.7), las = 2, col = c("#98DF8A", "#9EDAE5", "#FFBB78", "#F7B6D2"), border = "transparent", xaxt = "n", xaxs = "i", width = 1, space = c(0,2), xlim = c(0,80), yaxt = "n", beside = TRUE)
box(bty = "l")
names <- colnames(pure_scaleds)
names <- gsub("\\."," ", names)
font <- rep(3, length(names))
...
legend(x = 99, y = 99, xjust = 1, yjust = 1, fill = c("#98DF8A", "#9EDAE5", "#FFBB78","#F7B6D2", "#C5B0D5", "#C7C7C7"),
       legend = c("Block", "Water parameters", "Time", "Priority effects", "Shared with priority effects", "Shared among others"), border = "white", bty = "n")
...
barplot(pure_scaleds, ylim = c(0,0.7), las = 2, col = c("#98DF8A", "#9EDAE5", "#FFBB78", "#F7B6D2", "#C5B0D5"), border = "white", xaxt = "n", xaxs = "i", width = 1, space = c(0,1), xlim = c(0,6), yaxt = "n", beside = TRUE)
box(bty = "l")
